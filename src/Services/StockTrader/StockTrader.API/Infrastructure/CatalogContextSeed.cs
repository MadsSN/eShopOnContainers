namespace Microsoft.eShopOnContainers.Services.Catalog.API.Infrastructure
{
    ...
    {
        public async Task SeedAsync(StockTraderContext context,IWebHostEnvironment env,IOptions<StockTraderSettings> settings,ILogger<CatalogContextSeed> logger)
        {
        ...
        private IEnumerable<CatalogItem> GetCatalogItemsFromFile(string contentRootPath, StockTraderContext context, ILogger<CatalogContextSeed> logger)
        {

...
namespace Catalog.API.Grpc
{
    public class CatalogService : CatalogBase
    {
        ...
        public CatalogService(StockTraderContext dbContext, IOptions<StockTraderSettings> settings, ILogger<CatalogService> logger)
        {
            _settings = settings.Value;
            _stockTraderContext = dbContext ?? throw new ArgumentNullException(nameof(dbContext));
            _logger = logger;
        }
        ...
        public override async Task<CatalogItemResponse> GetItemById(CatalogItemRequest request, ServerCallContext context)
        {
            ...
            var item = await _stockTraderContext.CatalogItems.SingleOrDefaultAsync(ci => ci.Id == request.Id);

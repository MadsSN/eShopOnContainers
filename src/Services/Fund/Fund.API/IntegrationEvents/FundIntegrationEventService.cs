...
{
    public class FundIntegrationEventService : IFundIntegrationEventService
    {
        private readonly Func<DbConnection, IIntegrationEventLogService> _integrationEventLogServiceFactory;
        private readonly IEventBus _eventBus;
        private readonly FundContext _catalogContext;
        private readonly IIntegrationEventLogService _eventLogService;
        private readonly ILogger<FundIntegrationEventService> _logger;

        public FundIntegrationEventService(
            ILogger<FundIntegrationEventService> logger,
            IEventBus eventBus,
        ...
        public async Task SaveEventAndFundContextChangesAsync(IntegrationEvent evt)
        {
            _logger.LogInformation("----- FundIntegrationEventService - Saving changes and integrationEvent: {IntegrationEventId}", evt.Id);

...
namespace Fund.FunctionalTests
{
    public class FundScenariosBase
    {
        public TestServer CreateServer()
        {
            var path = Assembly.GetAssembly(typeof(FundScenariosBase))
              .Location;
            ...
            testServer.Host
                .MigrateDbContext<FundContext>((context, services) =>
                {

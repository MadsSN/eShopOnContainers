...
{
    public class ProductPriceChangedIntegrationEventHandler : IIntegrationEventHandler<ProductPricChangedIntegrationEvent>
    {
        ...
        public async Task Handle(ProductPricChangedIntegrationEvent @event)
        {
